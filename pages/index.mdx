...
Drum roll, please! And the theme for BeaverHacks Spring '21 is **Finance (FinTech)**!

Registration is now open! Please check out the registration page for more info. 

**Registration deadline is March 31st at 5:00 PM Pacific Time**.
...
<img src="./static/beaverhacks_spring.png" width="65%" height="65%" />  
